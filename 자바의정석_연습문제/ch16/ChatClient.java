...
class ChatClient extends Frame {
	...
	void startClient() {
		try {
			/*
			 * (3) 아래의 로직에 맞게 코드를 작성하시오. 1. 소켓을 생성하여 serverIp의 serverPort에 연결한다. 2. ta에
			 * "상대방과 연결되었습니다."라고 보여준다. ta.setText("상대방과 연결되었습니다."); 3. 연결된 상대방 소켓의 입력스트림과
			 * 출력스트립을 얻어온다. 4. 반복문을 이용해서 입력스트림이 null이 아닌 동안 입력스트림으로부터 데이터를 읽어서 변수 msg에 저장한다.
			 */
			ta.append("\r\n" + msg);
